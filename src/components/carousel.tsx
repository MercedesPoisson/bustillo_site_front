  ...
  return (
    ...
    >
      {images.map((image, index) => (
        <div key={index} style={{ height: '400px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <img className="object-cover h-full w-full" src={image} alt={`Bariloche ${index + 1}`} 
